...
namespace CarFactoryDatabaseImplement.Implements
{
    public class ImplementerStorage : IImplementerStorage
    {
        ...
        public List<ImplementerViewModel> GetFilteredList(ImplementerBindingModel model)
        {
            ...
            using var context = new CarFactoryDatabase();
            return context.Implementers
            .Where(rec => rec.Name.Contains(model.Name)).Select(CreateModel).ToList();
        }
        ...
        public ImplementerViewModel GetElement(ImplementerBindingModel model)
        {
            ...
            using var context = new CarFactoryDatabase();
            var component = context.Implementers.FirstOrDefault(rec => rec.Name == model.Name || rec.Id == model.Id);
